...
namespace RedisSessionWebApplication.App_Start
{
    /// <summary>
    /// WebConfig读写辅助类
    /// </summary>
    public class WebConfigManager : IDisposable
    {
        ...
        /// 设置SessionStateMode
        /// </summary>
        /// <param name="sessionStateMode"></param>
        public void SetSessionState(SessionStateMode sessionStateMode)
        {

            System.Web.Configuration.SessionStateSection sessionStateSection =
  (System.Web.Configuration.SessionStateSection)
  _config.GetSection("system.web/sessionState");
            sessionStateSection.Mode = sessionStateMode;
            Save();
        }
        /// <summary>
        /// 获取SessionStateMode
        /// </summary>
        public SessionStateMode GetSessionState()
        {
