...
$(function () {
    ...
    //                $("body").removeClass("boxed-layout"), $("body").addClass("fixed-nav"),
    //                $("#boxedlayout").prop("checked", !1), localStorageSupport &&
    //                    localStorage
    //                    .setItem("boxedlayout", "off"), localStorageSupport && localStorage.setItem("fixednavbar", "on")
    //            )
    //            : ($(".navbar-fixed-top").removeClass("navbar-fixed-top").addClass("navbar-static-top"),
    //                $("body").removeClass("fixed-nav"), localStorageSupport &&
    //                    localStorage.setItem("fixednavbar", "off"))
    //    });
    //$("#collapsemenu").click(function () {
    //        $("#collapsemenu").is(":checked")
    //            ? ($("body").addClass("mini-navbar"), SmoothlyMenu(),
    ...
    //            ? ($("body").addClass("boxed-layout"), $("#fixednavbar").prop("checked", !1),
    //                $(".navbar-fixed-top").removeClass("navbar-fixed-top").addClass("navbar-static-top"),
    //                $("body").removeClass("fixed-nav"), localStorageSupport &&
    //                    localStorage.setItem("fixednavbar", "off"),
    //                localStorageSupport && localStorage.setItem("boxedlayout", "on"))
    //            : ($("body").removeClass("boxed-layout"), localStorageSupport &&
